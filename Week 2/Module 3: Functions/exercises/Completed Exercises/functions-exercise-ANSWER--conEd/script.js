...
// Now call the function two times, and each time pass in a different string as an argument that you want to be alerted to the user.
...
let lengthOfArray = typesOfSoup.length;
console.log(getLength(lengthOfArray));

lengthOfArray = citiesInCanada.length;
console.log(getLength(lengthOfArray));	
...
function displayRandomIndex(array) {
	const length = array.length;
	const index = randomNumber(length);
	return `The random choice is ${array[index]}.`;
};

console.log(displayRandomIndex(citiesInCanada));
console.log(displayRandomIndex(typesOfSoup));
